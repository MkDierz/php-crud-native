<?php
include 'config.php';
$query = "SELECT * FROM tbl_dosen WHERE nip_dosen='$_GET[nip_dosen]'";
$data_dosen = mysqli_query($mysqli, $query);
$datashow = mysqli_fetch_array($data_dosen);
?>
<!DOCTYPE html>
<html>
            ...
            <div class="w-full lg:w-8/12 px-4">
                <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        <form action="edit_dosen_act.php" method="post">
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input value="<?= $datashow['nip_dosen'] ?>" name="nip_dosen" type="text"
                                ...
                                <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input value="<?= $datashow['nama_dosen'] ?>" name="nama_dosen" type="text"
                                               class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                    </div>
                                </div>
                                <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input value="<?= $datashow['no_hp_dosen'] ?>" name="no_hp_dosen" type="text"
                                               class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                    </div>
                                </div>
                                <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input value="<?= $datashow['kode_mk'] ?>" name="kode_mk" type="text"
                                               class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                    </div>
                                </div>
