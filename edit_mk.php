<?php
include 'config.php';
$query =  "SELECT * FROM tbl_matakuliah WHERE kode_mk='$_GET[kode_mk]'";
if (isset($mysqli)) {
    $data_mk = mysqli_query($mysqli,$query);
    $datashow = mysqli_fetch_array($data_mk);
}
?>
<!DOCTYPE html>
<html>
            ...
            <div class="w-full lg:w-8/12 px-4">
              <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                  <form action="edit_mk_act.php" method="post">
                    ...
                    <div class="flex flex-wrap">
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?= $datashow['kode_mk'];?>" name="kode_mk" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" disabled>
                          <input value="<?= $datashow['kode_mk'];?>" name="kode_mk" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" hidden>
                        </div>
                      </div>
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?= $datashow['nama_mk']?>" name="nama_mk" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" >
                        </div>
                      </div>
                    </div>
                    <input type="submit" name="update" value="EDIT" class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">
                  </form>
                </div>
              </div>
            </div>
